...
public class CamionRutaStrategy implements RutaStrategy {
    ...
    public Ruta crearRuta() {
        ...
        ruta.addPunto(new Despacho(-77.083665, -12.054374, "Jazmines", "Urgente", "7874321"));
        ruta.addPunto(new Despacho(-77.080250, -12.056479));
        ruta.addPunto(new Despacho(-77.077908, -12.065964));
        ruta.addPunto(new Despacho(-77.078538, -12.073385));
